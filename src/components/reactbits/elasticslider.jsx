...
function Slider({
  ...
  // Use controlled value if provided; fallback to internal state
  ...
  const getRangePercentage = () => {
    ...
    return ((sliderValue - startingValue) / totalRange) * 100;
  };
  ...
  return (
    <>
      ...
      >
        ...
        <div
          ref={sliderRef}
          className="relative flex w-full max-w-xs flex-grow cursor-grab select-none items-center py-4"
