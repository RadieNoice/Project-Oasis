...
import { Music, Play, Pause, X, Volume2, VolumeX, Plus, Link, Trash2 } from "lucide-react";
...
const MusicBox = () => {
  ...
  // Default music library with YouTube video IDs
  ...
  // Update iframe URL when track changes or play state changes
  useEffect(() => {
    if (iframeRef.current && activeVideo) {
      const params = `autoplay=${isPlaying ? 1 : 0}&mute=${isMuted ? 1 : 0}&controls=0`;
      iframeRef.current.src = `https://www.youtube.com/embed/${activeVideo}?${params}`;
    }
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Music List - Sleek scrollable area */}
            ...
            <div className="overflow-y-auto h-full py-2 px-1.5 space-y-1.5 custom-scrollbar">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg bg-black/20 flex items-center justify-center overflow-hidden shadow-inner">
                      <img 
                        ...
                        onError={(e) => {
                          e.target.src = "https://placehold.co/200x200/3730a3/ffffff?text=Music";
                        }}
                      />
                    </div>
              ...
              {musicLinks.length === 0 && (
                <div className="flex flex-col items-center justify-center h-full text-center p-4">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Click the + button to add tracks</p>
                </div>
              )}
            </div>
          </div>
        ...
        {/* Add Music Popup - Positioned over the music box */}
        <AnimatePresence>
          {showAddForm && (
            <motion.div 
              ref={modalRef}
              ...
              <div className="p-3.5">
                ...
                <form onSubmit={handleAddTrack} className="space-y-2.5">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="text-xs text-gray-300 mb-1 block">Title (optional)</label>
                      <input
                        type="text"
                        value={newMusicTitle}
                    ...
                    <div>
                      <label className="text-xs text-gray-300 mb-1 block">Category (optional)</label>
                      <input
                        type="text"
