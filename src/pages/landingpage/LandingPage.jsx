  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
      <ClickSpark
        ...
        duration={400}
      >
        {/* Your content here */}x{/* Background Layer */}
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-24">
              ...
              >
                ...
                >
                  ...
                  <RotatingText
                    texts={["Project", "Oasis"]}
                    mainClassName="w-fit h-fit px-1 sm:px-0.5 md:px-2 text-white py-1 sm:py-6 md:py-1 leading-tight justify-center rounded-md"
                    staggerFrom={"last"}
                    initial={{ y: "100%" }}
                    animate={{ y: 0 }}
                    exit={{ y: "-120%" }}
                ...
                >
                  ...
                  all-in-one productivity suite designed to help you thrive in
                ...
                >
                  <div className="flex -space-x-3">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="w-10 h-10 rounded-full border-2 border-black overflow-hidden bg-gradient-to-br from-gray-700 to-gray-900 cursor-pointer transform transition duration-300 hover:scale-110 hover:shadow-lg"
                      >
                        <img
                          src={`path/to/avatar${i}.jpg`}
                          alt={`User ${i}`}
              ...
              <div className="text-center mb-16">
                ...
                >
                  ...
                  <p className="text-gray-400 max-w-xl mx-auto">
                    ...
                    stay organized, focused, and productive throughout your day.
                  </p>
                </motion.div>
              </div>
            ...
            >
              <div className="text-center mb-16">
                ...
                >
                  ...
                  <p className="text-gray-400 max-w-xl mx-auto">
                    We offer flexible pricing plans to suit your requirements
                    and budget.
                  </p>
                </motion.div>
              </div>
            ...
            >
              <div className="text-center mb-16">
                ...
                >
                  ...
                  <p className="text-gray-400 max-w-xl mx-auto">
                    Welcome to Project Oasis, your ultimate companion for
                    efficient studying and task management. Our platform is
                    designed to help students and professionals stay organized
                    with powerful tools like personalized schedules, task
                    trackers, and study aids. Whether you're planning your day,
                    managing deadlines, or breaking down complex subjects,
                    Project Oasis offers a seamless experience to boost your
                    productivity. Stay focused, stay on track, and turn your
                    goals into achievements with Project Oasis — your digital
                    haven for success.
                  </p>
                </motion.div>
              </div>
